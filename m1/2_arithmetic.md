...
__Задача 2.__  Дано трехзначное число. 

Найдите его первую и последнюю цифру.
...
__Задача 3.__ Гелевая ручка стоит `x` рублей. 
...
__Задача 4.__ В летний лагерь нужно отвести `n` детей и `m` вожатых с помощью автобусов. 
